	...
	function(a, b) {
		a.alert = function(c, d, e, f) {
			if(a.os.plus) {
				...
				"function" == typeof d ? (f = d, d = null, e = "Chắc chắn") : "function" == typeof e && (f = e, e = null), a.plusReady(function() {
	...
	function(a, b, c) {
		var d = "mui-popup",
			...
			v = function(b, c, d, e, f) {
				return "undefined" != typeof b ? ("function" == typeof c ? (e = c, f = d, c = null, d = null) : "function" == typeof d && (f = e, e = d, d = null), a.os.plus && "div" !== f ? plus.nativeUI.alert(b, e, c || "提示", d || "Chắc chắn") : u(s(b, c || "提示") + t([d || "Chắc chắn"]), e)) : void 0
			},
