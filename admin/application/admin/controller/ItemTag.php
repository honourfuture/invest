 ...
 */
class ItemTag extends Controller
{
    /**
     * 绑定数据表
     * @var string
     */
    protected $table = 'LcItemTag';
    ...
    public function index()
    {
        ...
        $query->order('id desc')->page(false);
    }
...
//            $class = Db::name($this->table)->order('sort asc,id asc')->column('id,pid,zh_cn,zh_hk,en_us,th_th,vi_vn,ja_jp,ko_kr,ms_my,img,note');
