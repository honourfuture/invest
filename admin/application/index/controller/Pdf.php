...
class Pdf extends Controller
{
    public function show(){
        ...
        $contract = str_replace('${cycleNum}', $this -> q($item['cycle_type'], $invest['hour']), $contract);
    ...
    public function fl_table($money, $hour, $rate, $type, $time, $user_member, $period, $language, $investlist){
        ...
        $text = '<table border="1" cellpadding="0" cellspacing="0"><tbody><tr><td style="text-align:center;">'.$qs_arr[$language].'</td><td style="text-align:center;"><span style="color:#000000;"><span style="font-family:SimSun;">'.$lx_arr[$language].'</span></span></td><td style="text-align:center;"><span style="color:#000000;"><span style="font-family:SimSun;">'.$jx_arr[$language].'</span></span></td><td style="text-align:center;"><span style="color:#000000;"><span style="font-family:SimSun;">'.$bj_arr[$language].'</span></span></td><td style="text-align:center;"><span style="color:#000000;"><span style="font-family:SimSun;">'.$time_arr[$language].'</span></span></td></tr></tbody>' . $text . '</table>';
        return $text;
    }
}